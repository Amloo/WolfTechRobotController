...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 5762.252917370799; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -666.3615135242464; // x position of the perpendicular encoder (in tick units)
    }
